...
JSON output structure:
 ...
 {
    "success": false,
    "error": "Unable to get data: Data retrieval failed: BECOUSE IT FAILED.",
    "data": {
        "environment": {
        ...
        "history": {
            ...
            "last_message": "Exception performing check: HORRIBLE exception accoured while retrieving data.",
            "last_result_code": 0,
            "last_id": "d77f771a",
        ...
        "check": {
            ...
            "error_message": "Unable to get data: Data retrieval failed: BECOUSE IT FAILED.",
            "warning": false,
            "warning_message": "",
            "id": "284c5e3d"
        },
...
more flexible, becouse you can send more complex data. POST request method supports
...
=item L<AsProxy|P9::AA::Check::AsProxy>
