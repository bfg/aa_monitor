...
use P9::AA::Protocol::HTTP;

use vars qw(@ISA);
@ISA = qw(P9::AA::Protocol::HTTP);
...
L<P9::AA::Protocol::HTTPS> is limited HTTP/1.1 SSL (SSLv3/TLSv1) implementation of 
L<P9::AA::Protocol> interface.

=head1 METHODS

L<P9::AA::Protocol::HTTPS> inherits all methods from 
L<P9::AA::Protocol::HTTP> and implements the following methods:
...
This protocol implementation is based on L<P9::AA::Protocol::HTTP> and L<IO::Socket::SSL>.
