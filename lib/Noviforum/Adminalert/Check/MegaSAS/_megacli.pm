package Noviforum::Adminalert::Check::MegaSAS::_megacli;
...
use base 'Noviforum::Adminalert::Check::MegaSAS';
...
Implementation of L<Noviforum::Adminalert::Check::MegaSAS> module based
