...
use constant CLASS_CHECK => 'P9::AA::Check';
...
=cut
use constant CLASS_HARNESS => 'P9::AA::CheckHarness';
...
=cut
use constant CLASS_HISTORY => 'P9::AA::History';
...
=cut
use constant CLASS_DAEMON => 'P9::AA::Daemon';
...
=cut
use constant CLASS_RENDERER => 'P9::AA::Renderer';
...
=cut
use constant CLASS_PROTOCOL => 'P9::AA::Protocol';
...
=cut
use constant CLASS_CONFIG => 'P9::AA::Config';
...
=cut
use constant CLASS_CONNECTION => 'P9::AA::Connection';
