package Noviforum::Adminalert::Check::MongoDB;

use strict;
use warnings;

use Noviforum::Adminalert::Constants;
use base 'Noviforum::Adminalert::Check::JSON';
...
This module inherits all methods from L<Noviforum::Adminalert::Check::JSON>.
...
L<Noviforum::Adminalert::Check::JSON>,
