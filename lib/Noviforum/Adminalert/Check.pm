package Noviforum::Adminalert::Check;
...
use Noviforum::Adminalert::ParamValidator;
...
way of doing service check is to use L<Noviforum::Adminalert::CheckHarness> class.

=head1 METHODS

B<IMPORTANT:> This class inherits everything from L<Noviforum::Adminalert::Base> class.
...
This method behaves exactly as method B<factory()> in L<Noviforum::Adminalert::Base>
...
L<CHECK_ERR|Noviforum::Adminalert::Constants/CHECK_ERR>. To clear last error message call it with zero-length
string argument.
...
L<CHECK_WARN|Noviforum::Adminalert::Constants/CHECK_WARN>. To clear last warning message call it with zero-length
string argument.
...
Clears last error message (if called by subclass) and always returns L<CHECK_OK|Noviforum::Adminalert::Constants/CHECK_OK>.
...
B<NOTE>: Simple way to define validator subs is module L<Noviforum::Adminalert::ParamValidator>.
...
Returns string representation of specified arguments using L<Noviforum::Adminalert::Util#dumpVar>.
...
Returns shortest possible string representation of specified arguments using L<Noviforum::Adminalert::Util#dumpVarCompact>.
...
Shorcut method for L<Noviforum::Adminalert::Util#qx>
...
Shorcut method for L<Noviforum::Adminalert::Util#qx2>
...
L<Noviforum::Adminalert::History> objects are assigned after object
creation.

=head2 historyOld ($obj)

Sets/retrieves old history object. $obj must be initialized
L<Noviforum::Adminalert::History> object. 
...
See L<Noviforum::Adminalert::Check::EXAMPLE> for example check module.

=head1 PARAMETER VALIDATOR METHODS

Class implements some shortcuts for creating L<Noviforum::Adminalert::ParamValidator>
coderef validators.

=head2 validate_bool

See L<Noviforum::Adminalert::ParamValidator> for instructions.
...
sub validate_bool {
	shift;
	Noviforum::Adminalert::ParamValidator::validator_bool(@_);
}
...
sub validate_int {
	shift;
	Noviforum::Adminalert::ParamValidator::validator_int(@_);
}
...
sub validate_float {
	shift;
	Noviforum::Adminalert::ParamValidator::validator_float(@_);
}
...
sub validate_str {
	shift;
	Noviforum::Adminalert::ParamValidator::validator_str(@_);
}
...
sub validate_ucstr {
	shift;
	Noviforum::Adminalert::ParamValidator::validator_ucstr(@_);
}
...
sub validate_lcstr {
	shift;
	Noviforum::Adminalert::ParamValidator::validator_lcstr(@_);
}

=head2 validate_regex

See L<Noviforum::Adminalert::ParamValidator#validator_regex> for instructions.

=cut

sub validate_regex {
	shift;
	Noviforum::Adminalert::ParamValidator::validator_regex(@_);
}
...
L<Noviforum::Adminalert::EXAMPLE>,
L<Noviforum::Adminalert::Base>,
L<Noviforum::Adminalert::CheckHarness>
