package Noviforum::Adminalert::Renderer;
...
This class inherits all methods from L<Noviforum::Adminalert::Base>.

=head2 render

 my $formatted = $renderer->render($data, $dst);

Renders hash reference returned by L<Noviforum::Adminalert::CheckHarness/check> method.
...
L<Noviforum::Adminalert::Renderer::JSON>, 
L<Noviforum::Adminalert::Renderer::XML>,  
L<Noviforum::Adminalert::Renderer::HTML>, 
L<Noviforum::Adminalert::Renderer::PLAIN>
