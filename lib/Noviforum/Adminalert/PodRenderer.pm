...
package Noviforum::Adminalert::PodRenderer;
...
sub render {
	my ($self, $pkg) = @_;
	my $pod = '';
	return undef unless ($self->_getPod($pkg, \$pod));

	# create && configure POD parser
	my $parser = HtmlRend->new();
	$parser->index(2);
	$parser->force_title('');
...
# The following javascript code is completely
# stolen from excellent Mojolicious framework created
# by Sebastian Riedl.
#
# Origin file: http://mojolicio.us/js/prettify.js
#
__DATA__
