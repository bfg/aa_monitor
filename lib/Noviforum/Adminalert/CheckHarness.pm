package Noviforum::Adminalert::CheckHarness;
...
use Noviforum::Adminalert::History;
...
Wrapper around L<Noviforum::Adminalert::Check> class for simple service checking.
...
=head1 SYNOPSIS
 ...
 use Time::HiRes qw(time);
 use Noviforum::Adminalert::CheckHarness;
...
Tries to load $module implementation of L<Noviforum::Adminalert::Check> class, configures it with $params
and invokes L<Noviforum::Adminalert::Check|check()> method triggering service check.

This method also configures old/new service check history classes(L<Noviforum::Adminalert::History>), deals with
service check logging and time measuring.

Returns hash reference on success, otherwise undef and sets error message.

B<WARNING>: This method B<BLOCKS> during check execution. See L<Noviforum::Adminalert::CheckHarness::AnyEvent>
...
L<Noviforum::Adminalert::CheckHarness::AnyEvent>
