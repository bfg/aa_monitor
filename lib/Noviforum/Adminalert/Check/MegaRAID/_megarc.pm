package Noviforum::Adminalert::Check::MegaRAID::_megarc;
...
use base 'Noviforum::Adminalert::Check::MegaRAID';
...
B<megarc.bin> based implementation of L<Noviforum::Adminalert::Check::MegaRAID> module.
...
L<Noviforum::Adminalert::Check::MegaRAID>
