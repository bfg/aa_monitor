package Noviforum::Adminalert::History;
...
This class is used by L<Noviforum::Adminalert::CheckHarness> and L<Noviforum::Adminalert::Check>
...
L<Noviforum::Adminalert::Check/check> result and support information are considered as metadata. 
