...
L<P9::AA::Protocol> is abstract communication protocol class which inherits all
methods from L<P9::AA::Base>.
...
Returns initialized L<P9::AA::Renderer> object on success, otherwise undef.
...
L<P9::AA::Protocol::HTTP> HTTP protocol implementation

=item *

L<P9::AA::Protocol::HTTPS> HTTP protocol implementation

=item *

L<P9::AA::Protocol::FCGI> FastCGI protocol implementation

=item *

L<P9::AA::Protocol::CGI> CGI protocol implementation

=item *

L<P9::AA::Protocol::CMDL> Command line "protocol" implementation

=item *

L<P9::AA::Protocol::Renderer> Abstract data renderer
