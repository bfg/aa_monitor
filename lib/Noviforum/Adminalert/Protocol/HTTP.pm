package Noviforum::Adminalert::Protocol::HTTP;
...
use base 'Noviforum::Adminalert::Protocol::_HTTPCommon';
...
L<Noviforum::Adminalert::Protocol::HTTP> is limited HTTP/1.1 implementation of 
L<Noviforum::Adminalert::Protocol> interface.


=head1 METHODS

L<Noviforum::Adminalert::Protocol::HTTP> inherits all methods from 
L<Noviforum::Adminalert::Protocol> and implements the following methods:
